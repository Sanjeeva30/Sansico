...
const SECTIONS = `sections[]{
  ...
  cards[]{ tag, title, desc, meta, cta${LINK}, image${IMG}, icon${IMG}, bgColor, textColor, borderColor },
  tiles[]{ label, image${IMG}, cta${LINK}, bgColor, textColor },
  steps[]{ n, title, time, bgColor, textColor },
  faqs[]{ q, a },
  items[]{ title, desc, bgColor, textColor },
  logos[]{ name, logo${IMG} },
  pins[]{ label, x, y },
  ...
  certGroups[]->{ title, sub, column, accentColor, items[]{ name, "logoUrl": logo.asset->url, scope, entity } },
  ...
  scorecard->{ legend[]{ n, label }, columns, rows[]{ country, starred, scores, total, highlightColor },
