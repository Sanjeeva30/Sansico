...
export async function getCompany() {
  ...
  return {
    ...
    values: d.page?.values?.length ? d.page.values : [{title:"Stewardship",body:"Caring for our planet and its future."},{title:"Accountability",body:"Doing what is right and doing what we say."},{title:"Noble Execution",body:"Delivering quality, reliability, and consistency."},{title:"Safety \& People",body:"Protecting our team and helping them grow."},{title:"Innovation",body:"Finding better ways for people and the planet."}],
